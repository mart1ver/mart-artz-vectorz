...
| **Vidéo** | Décodage PyAV en cache (1× au démarrage), **contrôle de lecture par spot** (start / vitesse / play-pause-stop / loop / sens / sync), plein écran, sélection par canal, fixture de fond dédiée |
