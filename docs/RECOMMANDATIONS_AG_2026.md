...
1. ~~Créer un **remote git** (GitHub public) + `git push` — protection contre perte totale~~
...
| ~~Forme segment~~ | Visionary | Long terme | ✅ |
| ~~Multi-univers Python~~ | Visionary | Long terme | ✅ |
| ~~Canal blend/spot individuel~~ | Visionary | Long terme | ✅ |
| ~~Canal enable/disable par spot~~ | Visionary | Long terme | ✅ |
| ~~Police configurable GUI~~ | Visionary | Long terme | ✅ |
| Première démonstration publique | Visionary | — | 🔲 |
